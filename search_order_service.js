...
function extractMethod(methodName) {
  ...
  const start = lines.findIndex(l => l.includes(methodName + '('));
...
console.log("--- findByVendorOwner ---");
console.log(extractMethod('findByVendorOwner'));
console.log("\n--- getAvailableOrders ---");
console.log(extractMethod('getAvailableOrders'));
